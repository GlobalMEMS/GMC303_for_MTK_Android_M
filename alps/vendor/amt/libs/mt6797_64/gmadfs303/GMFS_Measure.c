...
)
{
	...
	ALOGI_IF(adb_Debug,"SOFTT,Brotate=(%8.3f,%8.3f,%8.3f)\n",prms->fva_hdata[0].v[0],prms->fva_hdata[0].v[1],prms->fva_hdata[0].v[2]); 
	akret = GMFS_Rotate(
		prms->e_hpat,
		&prms->fva_hdata[0]
	);

//	ALOGI_IF(adb_Debug,"SOFTT,Behdata=(%8.3f,%8.3f,%8.3f)\n",hdata[0].v[0],hdata[0].v[1],hdata[0].v[2]); 
	ALOGI_IF(adb_Debug,"SOFTTIRON=(%8.3f,%8.3f,%8.3f,%8.3f,%8.3f,%8.3f,%8.3f,%8.3f,%8.3f,V1.0=%8.2f)\n",
	soft[0],soft[1],soft[2],
	soft[3],soft[4],soft[5],
	soft[6],soft[7],soft[8],SOFT_IRON_Version
	); 
	
	ALOGI_IF(adb_Debug,"SOFTT,Arotate=(%8.3f,%8.3f,%8.3f)\n",prms->fva_hdata[0].v[0],prms->fva_hdata[0].v[1],prms->fva_hdata[0].v[2]); 
	...
	ALOGI_IF(adb_Debug,"SOFT,Trotate =(%8.3f,%8.3f,%8.3f)\n",
